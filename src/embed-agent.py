...
def main(argv):
    ...
    if host_os == "windows":
        ...
        for agent in {agent_modern, agent_legacy, agent_emulated_modern, agent_emulated_legacy}:
            ...
            embedded_agent = priv_dir / f"myagnt-{arch}.dll"
        ...
        for missing_arch in pending_archs:
            embedded_agent = priv_dir / f"myagnt-{missing_arch}.dll"
        ...
        embedded_agent = priv_dir / "myagnt.dylib"
        ...
        for agent, flavor in [(agent_modern, "64"),
            ...
            embedded_agent = priv_dir / f"myagnt-{flavor}.so"
        ...
        embedded_agent = priv_dir / "myagnt.so"
